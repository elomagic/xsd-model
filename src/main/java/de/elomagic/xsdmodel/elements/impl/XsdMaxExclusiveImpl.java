 ...
 */
public class XsdMaxExclusiveImpl extends AbstractValueElement<XsdMaxExclusive> implements XsdMaxExclusive {
    ...
    @Override
    @NotNull
    public XsdMaxExclusive setAnnotation(XsdAnnotation annotation) {
